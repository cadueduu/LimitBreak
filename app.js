...
// Chave pública (anon) — usada para login, queries e operações do frontend
...
// Chave de serviço — permite ao Admin ler fichas de outros alunos (ignora RLS)
// ATENÇÃO: esta chave dá acesso total ao banco. Nunca exponha em repositório público.
